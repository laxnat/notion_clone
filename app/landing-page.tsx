      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-8 text-center">
        ...
        >
          {user ? (
            <Link
              href="/documents"
              className="relative flex items-center gap-3 font-display text-xl text-secondary bg-highlight px-6 py-3 tracking-widest overflow-hidden group"
            >
              <span className="relative z-10 flex items-center gap-3">
                {user.avatarUrl ? (
                  <img src={user.avatarUrl} alt="" className="w-7 h-7 rounded-full object-cover shrink-0" />
                ) : (
                  <span className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-white font-ui text-sm shrink-0">
              ...
              <span className="absolute inset-0 flex items-center justify-center gap-3 translate-x-full group-hover:translate-x-0 transition-transform duration-300 z-20">
                {user.avatarUrl ? (
                  ...
                  <span className="w-7 h-7 rounded-full bg-highlight flex items-center justify-center text-white font-ui text-sm shrink-0">
                    {user.email[0].toUpperCase()}
                  </span>
                )}
